...
import { Youtube, Linkedin, Instagram, Twitter, MessageCircle, ArrowUpRight, Code2 } from "lucide-react";
...
export default function SocialLinks() {
  return (
    <main className="min-h-screen bg-[#0F172A] pt-24 pb-20 px-6 flex justify-center overflow-hidden relative">
      ...
      <div className="absolute top-20 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-[#FACC15] rounded-full blur-[150px] opacity-[0.03] pointer-events-none" aria-hidden="true" />
      ...
      <div className="w-full max-w-2xl z-10">
        ...
        >
          ...
          <div className="relative w-32 h-32 md:w-40 md:h-40 rounded-[2rem] border border-slate-700 bg-slate-800 shadow-2xl z-20 overflow-hidden rotate-[-2deg] hover:rotate-0 transition-all duration-500 group">
             <Image src="/profile-main.png" alt="Precious Oyebode Isaac" fill className="object-cover object-top" priority />
          </div>

          {/* Secondary Avatar Context */}
          <div className="absolute top-4 -right-4 md:-right-8 w-28 h-28 rounded-2xl border border-slate-700 bg-slate-800 shadow-xl z-10 overflow-hidden rotate-[12deg] opacity-80 hidden sm:block">
             <Image src="/precious.jpg" alt="Precious coding setup" fill className="object-cover grayscale hover:grayscale-0 transition-all" />
          </div>

          {/* Tertiary Avatar Context */}
          <div className="absolute top-8 -left-4 md:-left-8 w-24 h-24 rounded-2xl border border-slate-700 bg-slate-800 shadow-xl z-10 overflow-hidden rotate-[-15deg] opacity-70 hidden sm:block">
            <Image src="/santiago.jpg" alt="Precious speaking engagement" fill className="object-cover grayscale hover:grayscale-0 transition-all" />
          </div>
          ...
          <div className="text-center mt-8 relative z-30">
            <h1 className="text-2xl md:text-3xl font-black text-[#F8FAFC] flex items-center justify-center gap-2">
              your<span className="text-[#FACC15]">coderguy</span> <Code2 size={24} className="text-[#FACC15]" aria-hidden="true" />
            </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <motion.a
            ...
            aria-label="Contact Precious on WhatsApp for project inquiries"
          ...
          >
            <div className="absolute top-0 right-0 w-32 h-32 bg-[#FACC15] blur-[80px] opacity-20 group-hover:opacity-40 transition-opacity" aria-hidden="true" />
            ...
            <ArrowUpRight size={24} className="text-slate-400 group-hover:text-[#FACC15] group-hover:translate-x-1 group-hover:-translate-y-1 transition-all relative z-10" aria-hidden="true" />
          </motion.a>

          {/* Dynamic Social Router */}
          {socials.map((social, index) => (
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="font-bold text-[#F8FAFC] text-sm md:text-base">{social.name}</h2>
                  <p className="text-slate-500 text-xs md:text-sm tracking-wide">{social.handle}</p>
                </div>
              </div>
              <ArrowUpRight size={18} className="text-slate-600 group-hover:text-white transition-colors" aria-hidden="true" />
            </motion.a>
          ))}
          
          {/* Secondary Action Call (Global Routing) */}
          <motion.a
            href="/"
          ...
          >
            ...
            <ArrowUpRight size={18} className="text-slate-500 group-hover:text-[#FACC15] transition-colors" aria-hidden="true" />
          </motion.a>
